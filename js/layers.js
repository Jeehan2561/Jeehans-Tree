        ...
        "Main": {
            ...
            content:[
                "main-display",
                    ...
                    ["display-text",function() {if (hasMilestone('III', 0)) return "You have "+formatWhole(tmp.III.allowvar.sub(tmp.III.varsum))+"/"+formatWhole(tmp.III.allowvar)+" Varible points"}],
